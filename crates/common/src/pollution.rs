...
/// время на это есть.
pub const POLLUTION_MAX_TOXIN: f32 = 0.25;
...
///
/// Отсюда `K = 0.10`: одно тело даёт 0.04 уровня (яд 0.016 при стойкости 0.06,
/// то есть ничего), десять — 0.40, тридцать забивают клетку до предела.
///
...
pub const POLLUTION_PER_UPKEEP: f32 = 0.10;
